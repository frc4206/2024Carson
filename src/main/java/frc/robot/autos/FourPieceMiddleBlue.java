...
public class FourPieceMiddleBlue extends ParallelCommandGroup {
  public FourPieceMiddleBlue(ConveyorSubsystem conveyor, FlywheelSubsystem flywheel, IntakeSubsystem intake, PivotSubsystem pivot, SwerveSubsystem swerve) {
    addCommands(
