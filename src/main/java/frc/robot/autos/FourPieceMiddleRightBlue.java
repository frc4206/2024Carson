...
public class FourPieceMiddleRightBlue extends SequentialCommandGroup {
  public FourPieceMiddleRightBlue(ConveyorSubsystem conveyor, FlywheelSubsystem flywheel, IntakeSubsystem intake, PivotSubsystem pivot, SwerveSubsystem swerve) {
    addCommands(
      new ParallelCommandGroup(
        ...
        new SequentialCommandGroup(
          ...
          new ParallelCommandGroup(
            ...
            new PID_DistanceOdometry2(swerve, true, true, 3.95, 5.215, 355, 2, true)
          ),
          ...
          new PID_DistanceOdometry2(swerve, true, true, 5.3, 4.10, 0, 1.5, false),
          new ParallelCommandGroup(
            new PID_DistanceOdometry2(swerve, true, true, 8.00, 4.10, 0, 5, false),
            new GoUntilNoteCommand(conveyor, intake).until(() -> conveyor.hasNote())
          )
        )
      )
