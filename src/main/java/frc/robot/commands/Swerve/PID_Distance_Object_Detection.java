...
public class PID_Distance_Object_Detection extends Command {
  ...
  private double Go_to_Target_Distance;
  ...
  public PID_Distance_Object_Detection(SwerveSubsystem s_Swerve, Joystick controller, int translationAxis, int strafeAxis, int rotationAxis, boolean fieldRelative, boolean openLoop, double x_set, double y_set, double Go_to_Target_Distance) {
