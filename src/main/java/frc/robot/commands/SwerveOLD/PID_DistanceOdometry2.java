...
public class PID_DistanceOdometry2 extends Command {
	...
	public PID_DistanceOdometry2(SwerveOLD s_Swerve, boolean fieldRelative, boolean openLoop, double x_set, double y_set, double yaw_set, double timeout, boolean stop) {
